...
!pb
$latThree civilians were trapped and unable to escape after seeing a ghost in the restroom near Express Bus Terminal Station. At around 12:45 a.m., they were safely rescued and returned to reality.lat$

$latIf the ghost is safely returned to its original location, the supernatural phenomenon will conclude.lat$
pb!
...
!pb
$latAlthough the ghost has already lost its chosen offering, it cannot cause direct harm to the driver. However, various strange phenomena may occur inside the vehicle. Do not panic and respond calmly.lat$

$latNow, to explain the vehicle assigned to you.lat$
pb!
...
!pb
$latThe ghost will check the license plate at the taxi stand, then board the vehicle assigned to you.lat$
pb!
...
!pb
$latIf the driver shows signs of agitation, the ghost may leave the taxi.lat$

$latIn that case, the Disaster will not conclude. Please be careful.lat$
pb!
...
!pb
$latTurning on the radio will temporarily calm the ghost passenger.lat$
pb!
...
!pb
$latThough it resembles a real radio broadcast, the longer you listen, the more unsettling the content becomes.lat$

$latTraffic accidents dated a week into the future, condolences for disasters that haven’t happened, interviews with the dead, and so on.lat$

$latIt is recommended to leave the station on the initial broadcast. The more you change frequencies, the stranger—and more horrifying—the content is likely to become.lat$
pb!
