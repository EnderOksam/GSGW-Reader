...
#><[this section is for testing formatting, will not stay in the main site unless requested.]><#
...
@@ **distorted text but bolded** @@

@@ distorted text #rbutr# #baddedb# #ycolory# #pformattingp# #goptionsg# @@
...
@ll@Monospace left@ll@

@rr@Monospace right@rr@

~~~

+=
**Black Window (CRT effect)**

Bold text with a subtle scanline overlay.
=+
...
+-
Regular DER / Daydream records

[Good Friend]
-+

+$
follow up message for these
$+

&-
Distaster Management Bureau
...
mimicry and cleaning duty notes
-!

!$
follow up windows for notes

these ones look like sticky notes
$!