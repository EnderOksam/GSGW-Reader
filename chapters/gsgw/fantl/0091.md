...
!pb
$sst Upon discovering a meat-themed alley in Death Lane, do not enter. Stay in the previous alley. sst$

$sst If entry is unavoidable (e.g., being chased by a vendor), block out sound using earbuds and walk 1,000 steps as quickly as possible to move to the next alley. sst$

$sst If a companion gets caught up in a vendor’s sampling offer, leave them behind and move ahead at a faster pace. sst$
pb!
