...
$p
#f# *– Mr. Roe Deer, were your questions last night intended to engage in lengthy conversation with a ghost because you mistook me for one?* #f#
p$

That moment was genuinely spine-chilling.

$p
#f# – ...How could that be? I was simply keeping both possibilities in mind after seeing you clapping with the backs of your hands, sir. #f#
p$
...
$p
#f# – I couldn’t afford to miss the first chance to have an in-depth conversation with you, even if it meant risking a misunderstanding. #f#

#f# *– I see.* #f#

#f# – Thank you for kindly consulting with me for such a long time.#f#
...
“By any chance... Did ya also get a katalk message about makin' money?”
...
“I’ve heard a few other promisin' recruits got contacted as well!”

According to her, the identity of the sender varied each time, but two details always matched.

$p
#f# *[K.LEE: Oh hello, Mr./Ms. Employee lolol]* #f#
p$
...
“They must at least be connected! They knew wayyy too much about the Field Exploration Team.”
...
“Quite a few, actually. The company doesn’t care as long as we’re not sellin' Dream Essence Collectors or masks. It’s like how looting gets overlooked in wartime to keep soldiers’ morale up. Ugh.”
...
“Well, I mean... *technically*, people dyin' is eco-friendly, so whatevers.”

“......”

“But it’s the randomness that bugs me. If it were me, I’d send 'em off in order of personality. Ugh.”

I... think I’m scared of the C-squad.

“Anywayy, that’s just my take.”
...
$p
<!-- Rather than monospace it uses a pixel type font -->
@cc@ #* #p\<p##gSpace Shopping Mallg##p\>p# *# @cc@
@cc@ #b_ \>\>I’ll take a look at the *items*<<_b# @cc@
@cc@ #hx(#808080)$hxo(yellow)★ Grand Reopening Sale! ★hxo#hx# @cc@
@cc@ #hx(#808080)$hxo(yellow)Shocking prices!hxo#hx# @cc@
<!-- I'm crying there's also a drop shadow on the yellow text -->
p$
...
$p
<!-- Uses a pixel type font -->
@c@ $vcr #* #p\<p##gSpace Shopping Mallg##p\>p# *# vcr$ @c@
@c@ $vcr #b_ \>\>I’ll take a look at the *items*<<_b# vcr$ @c@
@c@ $vcr #hx(#808080)$hxo(yellow)★ Grand Reopening Sale! ★hxo#hx# vcr$ @c@
@c@ $vcr #hx(#808080)$hxo(yellow)Shocking prices!hxo#hx# vcr$ @c@
<!-- I'm crying there's also a drop shadow on the yellow text -->
p$
