...
$p
@c@ <span class="ssm2"> #* #p\<p##gSPACE SHOPPING MALLg##p>p# *# </span> @c@
@c@ <span class="ssm2"> #b_ \>\> I’ll take a look at the *items* <<_b# </span> @c@
@c@ <span class="ssm2"> #hx(#808080)$hxo(yellow)★ GRAND REOPENING SALE! ★hxo#hx# </span> @c@
@c@ <span class="ssm2"> #hx(#808080)$hxo(yellow)SHOCKING Prices!hxo#hx# </span> @c@
...
Even when an item wasn’t listed in the \<Darkness Exploration Records\>, there was at least a brief mention that allowed me to make a reasonable guess.
