...
$p
#f# *What? Was the situation secure now? Okay, then let’s test this and test that, put it through the manual revision process, and farm some points.* #f#
p$
...
And I also recognized some of the newly unlocked spaces from the \<Darkness Exploration Records\>.
...
The \<Darkness Exploration Records\> was an opensource wiki.
...
And through the \<Darkness Exploration Records\>, I already knew how to handle these.
