...
+$
The city is already in a ruins, and based on remaining records it can be inferred that it fell due to #rinfection from a biological disasterr#.
...
$p
#>< #f#𝐂𝐡𝐢𝐥𝐝𝐫𝐞𝐧,#f# <br> #f#𝐏𝐥𝐞𝐚𝐬𝐞 𝐭𝐚𝐤𝐞 𝐲𝐨𝐮𝐫 𝐡𝐨𝐧𝐞𝐲!#f# ><#
p$
