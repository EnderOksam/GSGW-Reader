...
$p
#f#– Y-You mean you can do that? Then we have to save as many people as we can!#f#
p$
...
Even according to the \<Darkness Exploration Records\>, seven survivors escaping was already guaranteed, so the individual point distribution wouldn’t have been above one-eighth regardless of whether I did this or not.
...
‘Even the Darkness Exploration Records had those sections censored!’
