...
!pb
$ips Qterw-C-1603 ips$

$ips Unregistered Exploration Testimony #21 ips$

$ips Security Clearance: [C] ips$
pb!
...
!pb
$ips ***Ad leaflet introducing a new product released, confirmed to be from Qterw-C-1603.*** ips$

$ips **Product name :** Good Child Chocolate Bar (Cinnamon Churros Flavor). ips$

$ips **Features :** Packaging depicts a caricature of a child’s face wearing a suit and a mask with tree branch-like goat horns. ips$

$ips ※ The character on the packaging resembles the company’s Field Exploration Team uniform. ips$

$ips Be cognizant in checking staff with a similar mask design. ips$
pb!
