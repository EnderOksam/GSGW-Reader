...
!pb
$sst Qterw-C-1603 sst$

$sst Unregistered Exploration Testimony #21 sst$

$sst Security Clearance: [C] sst$
pb!
...
!pb
$sst ***Ad leaflet introducing a new product released, confirmed to be from Qterw-C-1603.*** sst$

$sst **Product name :** Good Child Chocolate Bar (Cinnamon Churros Flavor). sst$

$sst **Features :** Packaging depicts a caricature of a child’s face wearing a suit and a mask with tree branch-like goat horns. sst$

$sst ※ The character on the packaging resembles the company’s Field Exploration Team uniform. sst$

$sst Be cognizant in checking staff with a similar mask design. sst$
pb!
