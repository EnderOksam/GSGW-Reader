...
!pb
$lat Qterw-C-1603 lat$

$lat Unregistered Exploration Testimony #21 lat$

$lat Security Clearance: [C] lat$
pb!
...
!pb
$lat ***Ad leaflet introducing a new product released, confirmed to be from Qterw-C-1603.*** lat$

$lat **Product name : Good Child Chocolate Bar (Cinnamon Churros Flavor).** lat$

$lat Features : Packaging depicts a caricature of a child’s face wearing a suit and a mask with tree branch-like goat horns. lat$

$lat ※ The character on the packaging resembles the company’s Field Exploration Team uniform. lat$

$lat Be cognizant in checking staff with a similar mask design. lat$
pb!
