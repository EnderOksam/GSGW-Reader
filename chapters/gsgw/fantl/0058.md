...
Since, once she left, the squad would naturally be down to its proper capacity.
...
“This time, the Darkness we’ll be exploring is a C-class zone[1](Editor Note: Author made a typo here and wrote 거미 (spider) instead of 구역 zone) from a known source with a completed manual.”
