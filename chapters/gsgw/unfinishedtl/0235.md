...
**A sanctuary used by members of the**

#r**Church of the Luminous Unknown**r#

**. It takes the form of an aged**

#r**underground bunker**r#

**and, being itself a ghost story, has no fixed location in reality. It moves between various places for the performance of religious rites and triggers multiple anomalous phenomena. For reference, see detailed records**
