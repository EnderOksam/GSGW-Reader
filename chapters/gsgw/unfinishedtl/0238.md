...
“Right in this spot. A long time ago, there was a festival where people drank liquor brewed with the centipede of the Mimicry Sect. Everyone there heard [Name]-nim’s voice and got their happy ending.”
...
“For the liquor to have the power to realize [Name]-nim, we need to soak something with the faithful and mystical authority of the Church of the Luminous Unknown, right?”
...
“When it’s finished, you should drink it too. Drink it, and come to know [Name]-nim.”

And then I realize one more emotion has returned to me.

*Known entity: [Name]-nim*
...
Author: [Name]
 ...
 /tn. [Name] (이름) in korean literally means "name", so the authors use "Name" to remain anonymous. But we're already so used to [Name] so I'm using [Name] instead of Name. 

That format.

Thus every wiki page was written as "Author: [Name]."
...
The Church of the Luminous Unknown mistook this “Author: [Name]” for a single great divine being and began worshipping it.
...
*You cannot run away from [Name]-nim.*
...
“Isn’t it ghost-story-like enough? People die for no reason, it’s actually a misunderstanding… it’s something [Name]-nim might pay attention to. That means we’re doing well.”
...
“[Name]-nim will like it, right?”

……

“[Name]-nim will like it and want to watch it longer!”
...
Ghost stories run rampant in this world because it is [Name]-nim’s will.

They know that.

And if that is the case, they must behave in ways that suit [Name]-nim’s tastes as much as possible—doing absurd things, creating interesting events, cruel acts, even grotesque situations.
