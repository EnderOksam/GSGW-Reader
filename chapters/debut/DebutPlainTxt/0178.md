...
"Let's wrap things up from here. Was hubae-nim's participation in
...
In this bastard's status window, the status abnormality that caused the reset, 'Remediation', was inactive In other words, the method to restart by dying was already blocked.
