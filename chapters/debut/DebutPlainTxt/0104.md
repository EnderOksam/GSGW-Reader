...
However, the conversation smelled like a convenience store part-timer and drunken Karen. -#(TL note: I feel the need to explain. The real word used here is Korean slang for a rude customer. I figured I should use the English equivalent to fit the context more.)#-
