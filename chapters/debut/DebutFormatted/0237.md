...
– Then, you should be alive. You’re talking nonsense.
...
I pitied Cha Eugene who had to stay in the dorm even on weekends and stayed in the hospital room.
...
He was a simple guy, so it was comfortable. His individualistic tendencies shone through.
...
"...I have to ask someone active for a long time."
...
"I’ve dealt with a guy like that before... After 16 months, the schedule fell apart. Hm, was it the 6th round? Haha."
...
There was no need to hide it. Even if I borrowed a cat's hand, I could use it in the right place at the right time with only the options left after losing the ability to reset.
...
Still, this bastard wasn't normal, so I had to move on quickly before he thought about anything else.
...
The year-end and New Year holidays were the highlights. Most of the concert halls that would fit TeStar's scale were already closed for the weekend.

Besides, I couldn't tell this guy, but if the lawsuit goes in, not just the tour, but the entertainment industry itself would go out of business this year.
...
The performance was simultaneously broadcast online, but both real-time paid and illegal visitors were not counted.
...
However, some performances actually counted on a non-face-to-face basis.

*The number of live comeback shows that were conducted on real-time paid W Lives was counted.*
...
It was not simply a VOD purchase, but 300,000 people must be in front of the computer at the same time.
...
Busy modern people only pay for it, and then do not watch it.
...
*Member solos, not TeStar, weren't specified in the contract.*

The remaining contractual and public opinion issues could be solved by adjusting the performance method, and it would be much easier and faster to do it with this guy. Because it was from his company.

*I think this is the best winning combination right now.*
...
In the calculation that it could calm the turbulent atmosphere by turning its attention somewhere else, the company sent an OK sign fairly quickly even though it was devastated.

It was because payment was due right after the weekend, on Monday morning.
