...
Basically, it was to not leave room for a clue to be held. In addition to that, in order to emphasize the main vocal position, I have responded smoothly to everything. -#(꼬투리를 잡히다 or a clue is held meaning is for something to become a pretext for someone to provoke a quarrel.)#-
...
Anyway, even if it is the wrong way, it doesn't matter as long as I reach Seoul. I tried to take KTX, but it means I don't mind taking the express bus. 'I got through the first step well.' -#(t/n : 모로 가도 서울만 가면 된다 used when one wants to say that achieving a goal is more important than how it is done. So even if it is the wrong way, it doesn't matter as long as you reach Seoul.)#-
...
I guess I succeeded in pulling the aggro properly. Of course, objectively speaking, it wasn't a crazy high rating. -#(t/n : aggro is a meaningless behavior or talk to take others' attention.)#-
...
These bastards are determined to eat raw. Even though that collaboration item sounds plausible, I'd bet my left hand that it was T1's product that Tnet was just promoting. -# (t/n: 날로 먹다 means that someone gets something easily without working hard.) #- 
...
The series, which I thought was ruined and ignored, suddenly got a response, so I put a spoon on it. Anyway, the MC's words were plausible. -#(t/n: I think 숟가락을 얹다 (if someone only puts a spoon on the table) means something like he is responsible for the most part of an achievement, so someone who deserves the credit for that achievement.) #-
...
"Ah, damn it. This dirty hand is not going anywhere." Surprisingly—it's worth using. -# (t/n: 똥손 means bad at picking something or unlucky person.) #-
