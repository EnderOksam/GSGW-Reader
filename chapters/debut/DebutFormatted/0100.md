...
"Why don't we pick game characters that resemble us the most and pick a B-side[1]{T/N: B-side is the song on the album that isn't the title track. In Korea, it's called sub-song.}. I thought long and hard about it and decided to go with the English equivalent. with them?"
...
Well-made game IP, it meant we just had to absorb it into our worldview[2]{Explained it before, but just in case you forgot, worldview = universe/lore!}.
