...
"However, if only the symbolic motive of the genre is reconstructed, it can compete well enough. The retro sentiment is trendy these days, so it's also a choice that can capture both popularity and batting eyes[1]{T/N: batting eyes = the ability to distinguish between a ball and a strike in baseball.}."
