<script lang="ts">
  ...
  const fontItems = [
    ...
    { syntax: "$ipstextips$", text: "digital text", cls: "ibm-plex-sans", expandable: true },
    ...
    { syntax: "$gpstextgps$", text: "retro stencil text", cls: "tenada", expandable: true },
  ...
  const windowsItems = [
    ...
    { syntax: "!pb...pb!", name: "paper window", cls: "paper-boat", code: "!pb\\npaper boat example\\npb!", html: '<p>paper boat example</p>', expandable: true },
